...
class MY_GUI():
    ...
    def set_init_window(self):
        ...
        self.wifi_mm_input = Entry(labelframe, width=10, textvariable=self.get_wifi_password_value).grid(column=3,
                                                                                                         row=2,
                                                                                                         sticky=W)
        ...
        while True:
            try:
                ...
                self.bool1 = self.connect(self.pwdStr,
                                          self.get_wifissid.encode('raw_unicode_escape', 'strict').decode(
                                              'gb18030'))
                # print("返回值：%s\n" %(self.bool1) )
                if self.bool1:
                    # print("密码正确："+pwdStr
                    ...
                    self.get_wifi_password_value.set(self.pwdStr)
